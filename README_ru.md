...
| Категория | Контент |
| --- | --- |
| 🛩️ Воздушные дроны | **Шахед**, **Дрон-камикадзе**, **Разведдрон**, **Бомбардировщик**, **Ракетный**, **Ганшип**, **Перехватчик**, **EMP** и **Скаут** дроны |
| 🚙 Наземная техника | **Джип**, **Автобус** (бронетранспортёр), **Разведмашина**, **БТР**, **Артиллерия**, **ОБТ**, **Тяжёлый ганшип** |
| 👑 Босс-юнит | **Jshon Ban** — 5000 HP + щит-силовое поле на 3000 HP, поджигает врагов в зоне щита, при смерти — многоуровневый взрыв (8000 урона вблизи, 300 до радиуса 250 тайлов) |
| 🔫 Турели | Автопушка, зенитка, рельсотрон, ракетная батарея, мортира, тесла, лазер, **Плазменная турель** и **Урановый метатель** (накладывает кастомный эффект **Облучение**) |
| ☢️ Ресурсы | Руда **Уран** + жидкость **Плазменная энергия** (новый «энергоноситель»), **Сталь**, **Снаряд** |
| 🏭 Производство и энергия | Заводы дронов/техники, тактические буры, сталелитейный, завод боеприпасов, **Плазменный реактор**, **Плазменная турбина**, дизель/солнце/аккумулятор |
| 🧱 Логистика и защита | Бронированные конвейер/распределитель/пересечение/мост, стальные и усиленные стены, бронедверь, проекторы ремонта/щита/ускорения |

Всего **40+ блоков и юнитов**. Все названия и описания переведены на **английский, русский и украинский**.
